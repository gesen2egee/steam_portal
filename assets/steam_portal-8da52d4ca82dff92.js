(function () {
    ...
    function mobileGameCardHtml(game) {
      ...
      var summaryCore = coreLabels ? '<div class="mobile-summary-core" aria-label="遊戲三大重點"><div class="mobile-summary-core-list">' + coreLabels + '</div></div>' : '';
    ...
    window.addEventListener("resize", function () {
      ...
      if (nextMobileLayout === lastMobileLayout) {
        if (nextMobileLayout) refreshMobileTitleMarquees();
        return;
      }
      syncMobileLayoutClass();
